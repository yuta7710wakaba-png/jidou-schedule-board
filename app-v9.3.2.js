...
const activitySound = new Audio("activity-change.mp3?v=9.3.2");
const warningSound = new Audio("mei-kara-mei-switch2.mp3?v=9.3.2");
const personalSound = new Audio("personal-alarm.mp3?v=9.3.2");
